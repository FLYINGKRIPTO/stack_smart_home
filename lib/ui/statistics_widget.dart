...
class StatisticsWidget extends StatelessWidget {
  ...
  List<BarDetail> items = [
    ...
    BarDetail(3, 22, "#A29996".fromHexToColor()),
    BarDetail(2, 40, Colors.white),
    BarDetail(17, 0, "#A29996".fromHexToColor()),
    BarDetail(3, 40, Colors.white),
    BarDetail(2, 20, "#A29996".fromHexToColor()),
    BarDetail(13, 12,Colors.white),
    BarDetail(3, 43, "#A29996".fromHexToColor()),
    BarDetail(29, 9, Colors.white),
    BarDetail(44, 1, "#A29996".fromHexToColor()),
    BarDetail(3, 2, Colors.white),
    BarDetail(33, 12, "#A29996".fromHexToColor()),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        children: [
          cardHeadingWidget(name: "Electricity Usage"),
          verticalSpace(16.0),
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return bar(top: items[index].top, bottom: items[index].bottom, color: items[index].color);
              },
            ),
          ),
          verticalSpace(16.0),
...
class BarDetail {
  ...
  BarDetail(this.top, this.bottom, this.color);
}
